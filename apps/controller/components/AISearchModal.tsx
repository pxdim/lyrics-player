...
import { X, Search, Mic, Plus, Eye, Check, AlertCircle, Star } from 'lucide-react';
...
export default function AISearchModal({
  ...
  // Debounce auto-search when query changes
  useEffect(() => {
  ...
  const handlePreview = async (song: SearchResult) => {
        ...
        try {
                const response = await fetch('/api/lyrics/search', {
                          method: 'POST',
                          headers: { 'Content-Type': 'application/json' },
                          body: JSON.stringify({ mode: 'lyrics', songName: song.songName, artist: song.artist }),
                });
  ...
  return (
        <>
                      ...
                      <div
                        ...
                        {warning && !selectedSong && (
                                              <div
                                                            ...
                                                            <p style={{ fontSize: DESIGN_TOKENS.fontSize.sm, color: '#f59e0b' }}>{warning}</p>p>
                                              </div>div>
                                )}
                                                ...
                                                {/* Search Results */}
                                                            <div className="px-6 pb-4 flex-1 overflow-y-auto max-h-[400px]">
                                                              {isSearching ? (
                                                                  ...
                                                                  <div className="text-center py-8">
                                                                                      <p style={{ color: DESIGN_TOKENS.colors.text.tertiary }}>沒有找到結果</p>p>
                                                                  </div>div>
                                                                ) : (
                                                                  <div className="text-center py-8">
                                                                                      <p style={{ color: DESIGN_TOKENS.colors.text.tertiary }}>輸入歌名開始搜尋</p>p>
                                                                  </div>div>
                                                                            )}
                                                            </div>div>
                                              </>>
                                                            ...
                                                            <div className="p-6 flex-1 overflow-y-auto">
                                                              {isPreviewLoading ? (
                                                                  ...
                                                                  <div
                                                                                      ...
                                                                                      <p style={{ color: '#ef4444' }}>{previewWarning}</p>p>
                                                                                      <button
                                                                                                                                      ...
                                                                                                                                      <div key={index} className="flex gap-3">
                                                                                                                                        {line.notes && (
                                                                                                                                                                ...
                                                                                                                                                                <p
                                                                                                                                                                                            ...
                                                                                                                                                                                            >
                                                                                                                                                                  {line.text || <span className="opacity-40">♪</span>span>}
                                                                                                                                                                  </p>p>
                                                                                                                                        </div>div>
                                                                                                                                    ))}
          ...
          {/* Auth Modal */}
              <AuthModal isOpen={showAuthModal} onClose={() => setShowAuthModal(false)} feature="收藏歌曲" />
        </>>
      );
}</></></></>
